        ...
        <TableHead>
            <TableRow>
                ...
                {headCells.map((headCell) => (
                    <TableCell
                        key={headCell.id}
                        id={`column-${headCell.id}`}
                        className={`search-table ${headCell.column}`}
                                ...
                                .map((row, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            {
                                                headCells.map((columnVal, columnKey) => {
                                                    return (
                                                        <TableCell
                                                            key={columnKey}
                                                            id={labelId}
                                                            className={`search-table ${columnVal.column}`}
                                                            style={columnVal.style}
                                                        >
                                                            {row[columnVal["column"]]}
                                                        </TableCell>
                                                    )
                                                })
                                            }
