      ...
      <>
        ...
        <>
          <div className="col-xl-12 col-lg-12 p-0">
            <div className="p-0 pb-3 search-input-wrapper">
              ...
              <div className="col-xl-3 p-0 search-tab-icon-wrapper">
                <div className="search-tab-icon red">
                  <svg.search className="img-fluid" />
                </div>
                <div className="search-tab-icon grey">
                  <svg.document className="img-fluid" />
                </div>
                <div className="search-tab-icon grey">
                  <svg.settingsround className="img-fluid" />
                </div>
              </div>
            </div>
